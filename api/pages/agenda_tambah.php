...
/**
 * Tambah Data Agenda
 * File: dashboard/agenda_tambah.php
 */
   ...
   <div class="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
      ...
      <div>
         ...
         <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-xs text-zinc-400">Tambah Agenda</span>
         </div>
         ...
         <p class="text-sm text-zinc-500 mt-1">
            Tambahkan kegiatan atau acara masjid baru
         </p>
   ...
   <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      <div class="xl:col-span-2">
         ...
         <div class="vercel-card p-5 sm:p-6">
            ...
            <form method="POST" action="index.php?page=agenda_aksi&aksi=tambah">
               ...
               <div>
                  ...
                  <div class="relative">
                     ...
                     <input type="text" id="judul" name="judul" required placeholder="Masukkan judul kegiatan"
               ...
               <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                     ...
                     <div class="relative">
                        ...
                        <input type="text" id="tanggal_mulai" name="tanggal_mulai" required
         ...
         <div class="vercel-card p-5 sm:p-6">
            ...
            <ul class="space-y-3 text-sm text-zinc-500">
               ...
               <li class="flex gap-2">
                  ...
                  Gunakan judul kegiatan yang jelas
               </li>

               <li class="flex gap-2">
                  <i class="ri-checkbox-circle-line text-zinc-400 mt-0.5"></i>
                  Pastikan tanggal kegiatan benar
               </li>

               <li class="flex gap-2">
                  <i class="ri-checkbox-circle-line text-zinc-400 mt-0.5"></i>
                  Tambahkan lokasi bila diperlukan
               </li>
